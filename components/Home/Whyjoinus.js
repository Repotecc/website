import image2 from '../../public/assets/img/undraw_wandering_mind_0mkm.png';
import image3 from '../../public/assets/img/undraw_time_management_30iu.png';
import image4 from '../../public/assets/img/undraw_team_page_pgpr.png';
            ...
            <div  className="why-join-us">
                ...
                <div  className="row">
                    <div  className="col-md">
                        <Image alt="vector 2" src={image2}  className="img-fluid" />
                    </div>
                    <div  className="col-md">
                ...
                <div  className="row">
                    ...
                    <div  className="col-md">
                        <Image alt="vector  3" src={image3}  className="img-fluid" />
                    </div>
                </div>

                <div  className="row">
                    <div  className="col-md">
                        <Image alt="vector 4" src={image4}  className="img-fluid" />
                    </div>
                    <div  className="col-md">
                        <h1><b>Join Us</b></h1>
                        <p>
